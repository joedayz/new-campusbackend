...
import { HangoutComponent } from 'app/entities/hangout/hangout.component';
import { HangoutService } from 'app/entities/hangout/hangout.service';
import { Hangout } from 'app/shared/model/hangout.model';

describe('Component Tests', () => {
    describe('Hangout Management Component', () => {
        let comp: HangoutComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HangoutComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.hangouts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
