...
import pe.joedayz.admin.config.audit.AuditEventConverter;
import pe.joedayz.admin.domain.PersistentAuditEvent;
...
import static pe.joedayz.admin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
